...
public class GameWaitingRoom extends JFrame {
	 ...
	 * Create the frame.
	 */
	public GameWaitingRoom(String id1, String id2, PrintWriter out, Scanner in) {
		// init
		this.id1 = id1;
		this.id2 = id2;
		this.out = out;
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// ??
				try {
					GameWaitingRoom.this.setVisible(false);
					WaitWindowView waitRoom = new WaitWindowView(id1, out, in);
		...
		while (in.hasNext()) {
			...
			// 게임 시작 명령이면,
				...
				new Game(splitMessage[1], splitMessage[2], in, out, Integer.parseInt(splitMessage[3]), turnFirst);
			}
